...
SELECT codigo_pac, nombre_pac, apellido_pac, cedula_pac, fecha_nacimiento_pac, fecha_registro_pac, antecedentes_pac, dolor_pac, marcha_pac, muscular_pac, neurologica_pac, articular_pac, discapacidad_pac, impresion_diagnostica_pac FROM Paciente WHERE (codigo_pac = SCOPE_IDENTITY())";
        ...
        public virtual int Fill(HogarAncianosDataSet1.Paciente1DataTable dataTable) {
        ...
        public virtual HogarAncianosDataSet1.Paciente1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HogarAncianosDataSet1.Paciente1DataTable dataTable = new HogarAncianosDataSet1.Paciente1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HogarAncianosDataSet1.Paciente1DataTable dataTable) {
