...
namespace Registro_Terapeutico
{
    public partial class ReporteMensual : Form
    {
        ...
        private void Nuevo_btn_Click(object sender, EventArgs e)
        {
            ...
            this.Registro_TerapeuticoTableAdapter.terapiasPorFechas(this.RegistroTerapias.Registro_Terapeutico,fecha_inicio.Value.Date.ToString("yyyy-MM-dd"), fecha_fin.Value.Date.ToString("yyyy-MM-dd"));
